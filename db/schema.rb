...
ActiveRecord::Schema[7.1].define(version: 2023_12_02_221055) do
  ...
  create_table "bookings_events", id: false, force: :cascade do |t|
    t.bigint "booking_id", null: false
    t.bigint "event_id", null: false
    t.index ["booking_id", "event_id"], name: "index_bookings_events_on_booking_id_and_event_id"
    t.index ["event_id", "booking_id"], name: "index_bookings_events_on_event_id_and_booking_id"
  end
  ...
  add_foreign_key "booking_events", "events"
