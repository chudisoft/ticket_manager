...
# 📖 [Ticket_Manager] <a name="about-project"></a>
This Ruby on Rails project is a web application where you can manage your tickets for events: users will have list of events to book from, and paid users can create events and generate tickets.
...
```sh
  git clone git@github.com:chudisoft/Ticket_Manager.git
  cd Ticket_Manager
  code .
```
-
